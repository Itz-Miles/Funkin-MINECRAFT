![logo](./art/logos/mod/logoHD.png)
___
# Source code for Funkin' MINECRAFT
If you want to funkin' play, visit [here](https://itz-miles.github.io/funkinMINECRAFTmod/play).

If you want to funkin' download, visit [releases](https://github.com/Itz-Miles/Funkin-MINECRAFT/releases/latest).

If you want to know what the funk Funkin MINECRAFT is, visit the [webpage](https://itz-miles.github.io/funkinMINECRAFTmod)!
...
Funkin MINECRAFT is not an official MINECRAFT product. Not approved by nor assosiated with Mojang Studios.
