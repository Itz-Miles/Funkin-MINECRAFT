...
class WeekEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	override function create()
	{
		...
		txtWeekTitle.setFormat(Paths.font("monocraft.ttf"), 32, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Paths.font("monocraft.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("monocraft.ttf");
