...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		nameText.setFormat(Paths.font("monocraft.ttf"), 32, FlxColor.WHITE, CENTER);
		nameText.scrollFactor.set();

		descText = new FlxText(50, nameText.y + 38, FlxG.width - 100, "", 24);
		descText.setFormat(Paths.font("monocraft.ttf"), 24, FlxColor.WHITE, CENTER);
		...
		progressTxt.setFormat(Paths.font("monocraft.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
...
class ResetAchievementSubstate extends MusicBeatSubstate
{
	...
	public function new()
	{
		...
		text.setFormat(Paths.font("monocraft.ttf"), 40, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		text.scrollFactor.set();
		text.borderSize = 2;
		add(text);
