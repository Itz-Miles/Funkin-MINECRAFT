...
haxelib set hxcpp 4.3.0
haxelib install parallaxlt 0.0.5
haxelib install hxcpp-debug-server
haxelib git discord_rpc https://github.com/Aidan63/linc_discord-rpc
haxelib git hxcpp https://github.com/HaxeFoundation/hxcpp v4.3.91ub.com/Haxhaxelib eFoundation/hxcpp v4.3.91
